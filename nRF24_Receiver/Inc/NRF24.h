...
#define CS_ON HAL_GPIO_WritePin(CSN_GPIO_Port, CSN_Pin, RESET)

#define CS_OFF HAL_GPIO_WritePin(CSN_GPIO_Port, CSN_Pin, SET)

#define CE_RESET HAL_GPIO_WritePin(CE_GPIO_Port, CE_Pin, RESET)

#define CE_SET HAL_GPIO_WritePin(CE_GPIO_Port, CE_Pin, SET)

#define IRQ HAL_GPIO_ReadPin(IRQ_GPIO_Port, IRQ_Pin)

#define LED_ON HAL_GPIO_WritePin(LED_GPIO_Port, LED_Pin, RESET)

#define LED_OFF HAL_GPIO_WritePin(LED_GPIO_Port, LED_Pin, SET)
